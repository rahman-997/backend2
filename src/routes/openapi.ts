    ...
    schemas: {
      Venue: {
        ...
        properties: {
          ...
          capacity: { type: "integer", minimum: 1, maximum: 2147483647 }, contactEmail: { type: "string", format: "email", maxLength: 320 }, createdAt: { type: "string", format: "date-time" },
        },
      },
      VenueInput: {
        type: "object",
        required: ["name", "address", "capacity", "contactEmail"],
        properties: { name: { type: "string", minLength: 1, maxLength: 255 }, address: { type: "string", minLength: 1, maxLength: 2000 }, capacity: { type: "integer", minimum: 1, maximum: 2147483647 }, contactEmail: { type: "string", format: "email", maxLength: 320 } },
      },
      VenuePatch: {
        type: "object",
        minProperties: 1,
