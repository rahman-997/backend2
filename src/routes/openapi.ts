  ...
  paths: {
    "/v1/venues": {
      ...
      post: {
        ...
        requestBody: {
          required: true,
          content: { "application/json": { schema: { "$ref": "#/components/schemas/VenueInput" } } },
        },
        responses: {
          201: { description: "Created" },
          400: { description: "Invalid input" },
          409: { description: "Duplicate venue name" },
        },
      },
    },
    "/v1/venues/{id}": {
      ...
      patch: {
        ...
        requestBody: {
          required: true,
          content: { "application/json": { schema: { "$ref": "#/components/schemas/VenuePatch" } } },
        },
